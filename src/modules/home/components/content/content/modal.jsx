...
const Modal = ({ modalPosition, closeModal, pasteId }) => {
    ...
    return (
        <div className="modal max-h-full overflow-y-auto p-2">
            ...
            >
                ...
                <div onClick={() => deletePasteAction(context.dispatch, context.state.user, context.state.selectedCollection.id, pasteId, closeModal)} className="flex gap-2 p-1 mb-1 px-3 pr-16 cursor-pointer hover:bg-gray-200 hover:rounded-xl">
                    <div>
